...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        comics.add(new Comix("unOrdinary", "uru-chan", "The world is not perfect. Learning to deal with its flaws is just a normal part of life. But there comes a point where these imperfections spawn a crushing realization... that something needs tp change...", "cover/unOrdinary.jpg", Comix.Genre.FANTASI, 776271));
        ...
        comics.add(new Comix("Eggnoid", "Archie The RedCat", "Hidup Ran yang kesepian jadi lebih berwarna akibat kehadiran Eggy. Cowok ganteng ini keluar dari telur misterius yang muncul di kamar Ran. Tetapi... Eggy tingkahnya seperti anak ayam yang baru menetas! Kira-kira dari mana asalnya ya?", "cover/Eggnoid.jpg", Comix.Genre.ROMANTIS, 776271));
